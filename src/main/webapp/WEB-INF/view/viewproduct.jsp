...
<tr>
    ...
    <td>
    <button type="submit"  formaction="/pmaven1/editproduct1/${list.pid}">Edit</button>
    <button type="submit" formmethod="post" formaction="/pmaven1/delete/${list.pid}">Delete</button>
    </td>
</tr>
</c:forEach>
</tbody>
